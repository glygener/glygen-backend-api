...
from glygen.biomarker_apilib import biomarker_detail, biomarker_search, biomarker_search_init, search_simple
    ...
    def post(self):
        ...
        try:
            ...
            if "error_list" not in res_obj:
                res_obj = search_one("biomarker_search_simple",req_obj,config_obj,True)
