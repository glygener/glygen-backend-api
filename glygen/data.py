...
class Data(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            log_obj = log_request(req_obj, "/data/list_download/", request)
...
class Data(Resource):
    ...
    def post(self):
        ...
        try:
            req_obj = get_req_obj(request)
            data_path = os.environ["DATA_PATH"]
            log_obj = log_request(req_obj, "/data/detail_download/", request)
            if "error_list" not in log_obj:
...
class Data(Resource):
    ...
    def post(self):
        ...
        try:
            req_obj = get_req_obj(request)
            data_path = os.environ["DATA_PATH"]
            log_obj = log_request(req_obj, "/data/section_download/", request)
            if "error_list" not in log_obj:
