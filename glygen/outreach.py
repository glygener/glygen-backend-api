...
class Outreach(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            log_obj = log_request(req_obj, "/outreach/addnew/", request)
...
class Outreach(Resource):
    ...
    def post(self):
        ...
        try:
            req_obj = get_req_obj(request)
            log_obj = log_request(req_obj, "/outreach/update/", request)
            current_user = get_jwt_identity()
            if "error_list" not in log_obj:
...
class Outreach(Resource):
    ...
    def post(self):
        ...
        try:
            req_obj = get_req_obj(request)
            log_obj = log_request(req_obj, "/outreach/list/", request)
            if "error_list" not in log_obj:
