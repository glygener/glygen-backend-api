...
import csv
import traceback
import newsupersearch_apilib as apilib
import errorlib
import util
...
config_obj["ignored_edges"] = json.loads(open("./conf/newedgerules.json", "r").read())

@app.route('/newsupersearch/search_init/', methods=['GET', 'POST'])
def search_init():
...
@app.route('/newsupersearch/search/', methods=['GET', 'POST'])
...
@app.route('/newsupersearch/reason/', methods=['GET', 'POST'])
...
@app.route('/newsupersearch/list/', methods=['GET', 'POST'])
